...
The case ID, category, level, technologies, failure modes, patterns, and status. At minimum, include `ID`, `Category`, `Level`, `Technologies`, and `Status`. Use [TAGS.md](TAGS.md) for the accepted `Category` and `Level` values.
